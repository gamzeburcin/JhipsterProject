...
describe('Component Tests', () => {
  describe('CarImage Management Component', () => {
    let comp: CarImageComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CarImageComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.carImages?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
