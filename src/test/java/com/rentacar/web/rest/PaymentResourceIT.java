...
class PaymentResourceIT {
     ...
     *
     * @see com.rentacar.repository.search.PaymentSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().amount(DEFAULT_AMOUNT);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().amount(UPDATED_AMOUNT);
        return payment;
    }
    ...
    void putNewPayment() throws Exception {
        ...
        updatedPayment.amount(UPDATED_AMOUNT);
